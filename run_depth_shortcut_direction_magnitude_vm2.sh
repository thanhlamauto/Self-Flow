...
# Direction-magnitude SiT-B/2 ablation VM2: P-Base and P-Large.
...
run_variant base ./checkpoints-depth-shortcut-base-dir-mag
run_variant large ./checkpoints-depth-shortcut-large-dir-mag
