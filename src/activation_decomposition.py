...
def compute_private_loss(
    ...
    *,
    ...
    """Compute only the private activation diversity loss.

    This is the private component from ``compute_aux_losses`` without the
    spatial Gram or common/private orthogonality losses.
    """
