...
def flattened_pairwise_cosine_squared(
    ...
    """Match the flat ``B*N*D`` private cosine loss used in ``feat/common-private-activations``."""
...
def compute_aux_losses(
    ...
    *,
    ...
    if compute_diversity_loss:
        ...
        private_residual = normalized_private_layers - mean_activations[None, ...]
        ...
        private_residual = normalized_window - mean_activations[None, ...]
