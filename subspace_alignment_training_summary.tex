...
To reduce the chance of spectral degeneracy in the train-side TSVD, we add a very small Gaussian perturbation before forming $G_H$:
\[
...
For additional numerical stability, the implementation uses the exact Gram eigenspace in the forward pass, but sends the backward pass through a stabilized subspace-iteration surrogate. This keeps the TSVD projector target unchanged while avoiding undefined eigenvector gradients at repeated or nearly repeated eigenvalues.
