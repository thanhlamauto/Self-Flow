...
echo -e "${GREEN}=============================================================${NC}"
echo ""
echo "cd $REPO_DIR && python -m train.train_mdm \\"
echo "  --save_dir ./save/humanml_mdm_depth_shortcut_hybrid_deep_12pct_outputdistill \\"
echo "  --overwrite \\"
echo "  --dataset humanml \\"
echo "  --arch trans_enc \\"
echo "  --text_encoder_type clip \\"
echo "  --layers 8 \\"
echo "  --latent_dim 512 \\"
echo "  --cond_mask_prob 0.1 \\"
echo "  --mask_frames \\"
echo "  --lambda_rcxyz 0.0 \\"
echo "  --lambda_vel 0.0 \\"
echo "  --lambda_fc 0.0 \\"
echo "  --lambda_target_loc 0.0 \\"
echo "  --batch_size 64 \\"
echo "  --lr 1e-4 \\"
echo "  --predictor-learning-rate 1e-4 \\"
echo "  --weight_decay 0.1 \\"
echo "  --shortcut-predictor-weight-decay 0.1 \\"
echo "  --lr_anneal_steps 0 \\"
echo "  --num_steps 200000 \\"
echo "  --diffusion_steps 50 \\"
echo "  --noise_schedule cosine \\"
echo "  --sigma_small True \\"
echo "  --shortcut-predictor hybrid_deep_12pct \\"
echo "  --shortcut-training-mode direction-magnitude \\"
echo "  --shortcut-lambda-dir 1.0 \\"
echo "  --shortcut-lambda-boot 0.25 \\"
echo "  --shortcut-lambda-mag 0.375 \\"
echo "  --shortcut-lambda-boot-mag 0.1875 \\"
echo "  --shortcut-mag-scale 2.2 \\"
echo "  --shortcut-mag-abs-center 2.9 \\"
echo "  --shortcut-mag-abs-scale 0.6 \\"
echo "  --shortcut-mag-clip-min 0.8 \\"
echo "  --shortcut-mag-clip-max 3.5 \\"
echo "  --shortcut-skip-in-loop-max-gap 7 \\"
echo "  --shortcut-skip-in-loop-gap-loc 2.0 \\"
echo "  --shortcut-skip-in-loop-gap-sigma 1.5 \\"
echo "  --output-distill \\"
echo "  --output-distill-ratio 0.10 \\"
echo "  --lambda-output-distill 0.05 \\"
echo "  --output-distill-every 1 \\"
echo "  --output-distill-update-mode predictor_plus_all \\"
echo "  --output-distill-pair-mode trunc_normal_centered \\"
echo "  --direct-pair-mode trunc_normal_centered \\"
echo "  --pair-center-sigma 1.3 \\"
echo "  --direct-num-pairs 1 \\"
echo "  --direct-joint-pairs 1 \\"
echo "  --direct-predictor-only-pairs 0 \\"
echo "  --shortcut-bootstrap-detach-source \\"
echo "  --shortcut-predictor-use-timestep \\"
echo "  --no-shortcut-predictor-normalize-input \\"
echo "  --timestep-sampling-mode logit_normal \\"
echo "  --timestep-logit-mean 0.0 \\"
echo "  --timestep-logit-std 1.0 \\"
echo "  --private-loss \\"
echo "  --lambda-private 1.0 \\"
echo "  --private-max-pairs 2 \\"
echo "  --private-use-residual \\"
echo "  --private-cosine-mode bnd \\"
echo "  --private-pair-mode random \\"
echo "  --eval_batch_size 32 \\"
echo "  --eval_split val \\"
echo "  --eval_during_training \\"
echo "  --eval_rep_times 3 \\"
echo "  --eval_num_samples 1000 \\"
echo "  --log_interval 50 \\"
echo "  --save_interval 50000 \\"
echo "  --num_frames 60 \\"
echo "  --resume_checkpoint \"\" \\"
echo "  --train_platform_type NoPlatform \\"
echo "  --gen_guidance_param 2.5 \\"
echo "  --avg_model_beta 0.9999 \\"
echo "  --adam_beta2 0.999 \\"
echo "  --seed 10 \\"
echo "  --cuda True \\"
echo "  --device 0"
echo ""
